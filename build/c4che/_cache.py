...
DEFINES = ['NS3_BUILD_PROFILE_RELEASE', 'HAVE_SYS_IOCTL_H=1', 'HAVE_IF_NETS_H=1', 'HAVE_NET_ETHERNET_H=1', 'HAVE_PACKET_H=1', 'HAVE_IF_TUN_H=1', 'HAVE_=1']
...
EXAMPLE_DIRECTORIES = ['realtime', 'tutorial', 'error-model', 'socket', 'routing', 'stats', 'energy', 'matrix-topology', 'traffic-control', 'udp-client-server', 'ipv6', 'udp', 'tcp', 'wireless', 'naming']
...
NS3_EXECUTABLE_PATH = ['/media/zero/Stockage/ns-3-dev-git/build/src/fd-net-device', '/media/zero/Stockage/ns-3-dev-git/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/4.8', '/media/zero/Stockage/ns-3-dev-git/build']
...
cfg_files = ['/media/zero/Stockage/ns-3-dev-git/build/ns3/config-store-config.h', '/media/zero/Stockage/ns-3-dev-git/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
